...
@pytest.mark.parametrize("context_size,expected_shape", [
...
def test_bad_sbsgenerator(context_size: int) -> None:
    ...
    Returns:
        None
    """
    with pytest.raises(generator.NoCorrectSBSMutationsFound, match="No correct SBS mutations found in VCF files") as _:
        sbsgen = generator.SBSGenerator(
            context=context_size,
